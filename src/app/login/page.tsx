...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col md:flex-row">
      <div className="relative hidden h-64 md:block md:h-auto md:w-3/5 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url(https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=1200&q=80)",
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent" />
        <div className="absolute bottom-8 left-8 text-white">
          <h2 className="text-3xl font-bold">Copa do Mundo 2026</h2>
          <p className="text-lg text-white/80">Faça login para acompanhar</p>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center p-6 md:w-2/5">
        <div className="w-full max-w-sm space-y-6">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Não tem conta?{" "}
            <Link href="/cadastro" className="font-medium text-fifa-verde hover:underline">
              Cadastre-se
            </Link>
          </p>
        </div>
